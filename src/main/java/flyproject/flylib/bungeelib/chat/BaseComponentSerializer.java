...
import flyproject.flylib.bungeelib.chat.ComponentSerializer;
...
public class BaseComponentSerializer
{
    ...
    {
        boolean first = false;
        if ( flyproject.flylib.bungeelib.chat.ComponentSerializer.serializedComponents.get() == null )
        {
            first = true;
            flyproject.flylib.bungeelib.chat.ComponentSerializer.serializedComponents.set( Collections.newSetFromMap( new IdentityHashMap<BaseComponent, Boolean>() ) );
        }
        try
        {
            Preconditions.checkArgument( !flyproject.flylib.bungeelib.chat.ComponentSerializer.serializedComponents.get().contains( component ), "Component loop" );
            flyproject.flylib.bungeelib.chat.ComponentSerializer.serializedComponents.get().add( component );
        ...
        {
            flyproject.flylib.bungeelib.chat.ComponentSerializer.serializedComponents.get().remove( component );
            if ( first )
            {
