package flyproject.flylib.bungeelib.api.chat;
...
import flyproject.flylib.bungeelib.api.ChatColor;
...
public final class ComponentBuilder
{
    ...
    @Getter
    private final List<flyproject.flylib.bungeelib.api.chat.BaseComponent> parts = new ArrayList<flyproject.flylib.bungeelib.api.chat.BaseComponent>();
    private flyproject.flylib.bungeelib.api.chat.BaseComponent dummy;

    private ComponentBuilder(flyproject.flylib.bungeelib.api.chat.BaseComponent[] parts)
    {
        for ( flyproject.flylib.bungeelib.api.chat.BaseComponent baseComponent : parts )
        {
    ...
    {
        this( original.parts.toArray( new flyproject.flylib.bungeelib.api.chat.BaseComponent[ 0 ] ) );
    }
    ...
    {
        this( new flyproject.flylib.bungeelib.api.chat.TextComponent( text ) );
    }
     ...
     */
    public ComponentBuilder(flyproject.flylib.bungeelib.api.chat.BaseComponent component)
    {

        this( new flyproject.flylib.bungeelib.api.chat.BaseComponent[]
        {
            component
        } );
    }

    private flyproject.flylib.bungeelib.api.chat.BaseComponent getDummy()
    {
        if ( dummy == null )
        {
            dummy = new flyproject.flylib.bungeelib.api.chat.BaseComponent()
            {
                @Override
                public flyproject.flylib.bungeelib.api.chat.BaseComponent duplicate()
                {
                    return this;
                }
            };
     ...
     * @return this ComponentBuilder for chaining
     */
    public ComponentBuilder append(flyproject.flylib.bungeelib.api.chat.BaseComponent component)
    {
     ...
     * @return this ComponentBuilder for chaining
     */
    public ComponentBuilder append(flyproject.flylib.bungeelib.api.chat.BaseComponent component, FormatRetention retention)
    {
        flyproject.flylib.bungeelib.api.chat.BaseComponent previous = ( parts.isEmpty() ) ? null : parts.get( parts.size() - 1 );
        if ( previous == null )
        {
            previous = dummy;
            dummy = null;
     ...
     * @return this ComponentBuilder for chaining
     */
    public ComponentBuilder append(flyproject.flylib.bungeelib.api.chat.BaseComponent[] components)
    {
     ...
     * @return this ComponentBuilder for chaining
     */
    public ComponentBuilder append(flyproject.flylib.bungeelib.api.chat.BaseComponent[] components, FormatRetention retention)
    {
        Preconditions.checkArgument( components.length != 0, "No components to append" );

        for ( flyproject.flylib.bungeelib.api.chat.BaseComponent component : components )
        {
    ...
    {
        return append( flyproject.flylib.bungeelib.api.chat.TextComponent.fromLegacyText( text ) );
    }
     ...
     * ({@code index < 0 || index >= size()})
     */
    public flyproject.flylib.bungeelib.api.chat.BaseComponent getComponent(int pos) throws IndexOutOfBoundsException
    {
     ...
     */
    public flyproject.flylib.bungeelib.api.chat.BaseComponent getCurrentComponent()
    {
     ...
     */
    public flyproject.flylib.bungeelib.api.chat.BaseComponent[] create()
    {
        flyproject.flylib.bungeelib.api.chat.BaseComponent[] cloned = new flyproject.flylib.bungeelib.api.chat.BaseComponent[ parts.size() ];
        int i = 0;
