...
public class ItemSerializer implements JsonSerializer<flyproject.flylib.bungeelib.api.chat.hover.content.Item>, JsonDeserializer<flyproject.flylib.bungeelib.api.chat.hover.content.Item>
{

    @Override
    public flyproject.flylib.bungeelib.api.chat.hover.content.Item deserialize(JsonElement element, Type type, JsonDeserializationContext context) throws JsonParseException
    {
        ...
        return new flyproject.flylib.bungeelib.api.chat.hover.content.Item(
