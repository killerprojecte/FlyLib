...
import flyproject.flylib.bungeelib.chat.TranslationRegistry;
...
public final class TranslatableComponent extends flyproject.flylib.bungeelib.api.chat.BaseComponent
{
     ...
     */
    private List<flyproject.flylib.bungeelib.api.chat.BaseComponent> with;
    ...
    public TranslatableComponent(TranslatableComponent original)
    {
        ...
        {
            List<flyproject.flylib.bungeelib.api.chat.BaseComponent> temp = new ArrayList<flyproject.flylib.bungeelib.api.chat.BaseComponent>();
            for ( flyproject.flylib.bungeelib.api.chat.BaseComponent baseComponent : original.getWith() )
            {
     ...
     * {@link flyproject.flylib.bungeelib.api.chat.BaseComponent}s to use into the
     * translation
     * @see #translate
     * @see #setWith(List)
     */
    public TranslatableComponent(String translate, Object... with)
    {
        ...
        if ( with != null && with.length != 0 )
        {
            ...
            for ( Object w : with )
            {
                if ( w instanceof flyproject.flylib.bungeelib.api.chat.BaseComponent)
                {
                    temp.add( (flyproject.flylib.bungeelib.api.chat.BaseComponent) w );
                } else
                {
                    temp.add( new flyproject.flylib.bungeelib.api.chat.TextComponent( String.valueOf( w ) ) );
                }
            }
            setWith( temp );
        }
     ...
     */
    public void setWith(List<flyproject.flylib.bungeelib.api.chat.BaseComponent> components)
    {
     ...
     */
    public void addWith(flyproject.flylib.bungeelib.api.chat.BaseComponent component)
    {
        if ( with == null )
        {
            with = new ArrayList<flyproject.flylib.bungeelib.api.chat.BaseComponent>();
        }
        component.parent = this;
        with.add( component );
    }
