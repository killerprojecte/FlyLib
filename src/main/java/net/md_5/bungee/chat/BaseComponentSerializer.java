...
public class BaseComponentSerializer
{
    ...
    {
        boolean first = false;
        if ( net.md_5.bungee.chat.ComponentSerializer.serializedComponents.get() == null )
        {
            first = true;
            net.md_5.bungee.chat.ComponentSerializer.serializedComponents.set( Collections.newSetFromMap( new IdentityHashMap<BaseComponent, Boolean>() ) );
        }
        try
        {
            Preconditions.checkArgument( !net.md_5.bungee.chat.ComponentSerializer.serializedComponents.get().contains( component ), "Component loop" );
            net.md_5.bungee.chat.ComponentSerializer.serializedComponents.get().add( component );
        ...
        {
            net.md_5.bungee.chat.ComponentSerializer.serializedComponents.get().remove( component );
            if ( first )
            {
