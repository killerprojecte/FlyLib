...
public final class TextComponent extends net.md_5.bungee.api.chat.BaseComponent
{
     ...
     * @return the components needed to print the message to the client
     */
    public static net.md_5.bungee.api.chat.BaseComponent[] fromLegacyText(String message, ChatColor defaultColor)
    {
        ArrayList<net.md_5.bungee.api.chat.BaseComponent> components = new ArrayList<net.md_5.bungee.api.chat.BaseComponent>();
        ...
        for ( int i = 0; i < message.length(); i++ )
        {
            ...
            { //Web link handling
                ...
                component.setClickEvent( new net.md_5.bungee.api.chat.ClickEvent( ClickEvent.Action.OPEN_URL,
     ...
     */
    public TextComponent(net.md_5.bungee.api.chat.BaseComponent... extras)
    {
        this();
        if ( extras.length == 0 )
        {
