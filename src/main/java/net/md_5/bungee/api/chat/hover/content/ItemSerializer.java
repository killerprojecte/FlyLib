...
public class ItemSerializer implements JsonSerializer<net.md_5.bungee.api.chat.hover.content.Item>, JsonDeserializer<net.md_5.bungee.api.chat.hover.content.Item>
{

    @Override
    public net.md_5.bungee.api.chat.hover.content.Item deserialize(JsonElement element, Type type, JsonDeserializationContext context) throws JsonParseException
    {
