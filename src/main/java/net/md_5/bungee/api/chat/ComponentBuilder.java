...
public final class ComponentBuilder
{
    ...
    @Getter
    private final List<net.md_5.bungee.api.chat.BaseComponent> parts = new ArrayList<net.md_5.bungee.api.chat.BaseComponent>();
    private net.md_5.bungee.api.chat.BaseComponent dummy;

    private ComponentBuilder(net.md_5.bungee.api.chat.BaseComponent[] parts)
    {
        for ( net.md_5.bungee.api.chat.BaseComponent baseComponent : parts )
        {
    ...
    {
        this( original.parts.toArray( new net.md_5.bungee.api.chat.BaseComponent[ 0 ] ) );
    }
    ...
    {
        this( new net.md_5.bungee.api.chat.TextComponent( text ) );
    }
     ...
     */
    public ComponentBuilder(net.md_5.bungee.api.chat.BaseComponent component)
    {

        this( new net.md_5.bungee.api.chat.BaseComponent[]
        {
            component
        } );
    }

    private net.md_5.bungee.api.chat.BaseComponent getDummy()
    {
        if ( dummy == null )
        {
            dummy = new net.md_5.bungee.api.chat.BaseComponent()
            {
                @Override
                public net.md_5.bungee.api.chat.BaseComponent duplicate()
                {
                    return this;
                }
            };
     ...
     * @return this ComponentBuilder for chaining
     */
    public ComponentBuilder append(net.md_5.bungee.api.chat.BaseComponent component)
    {
     ...
     * @return this ComponentBuilder for chaining
     */
    public ComponentBuilder append(net.md_5.bungee.api.chat.BaseComponent component, FormatRetention retention)
    {
        net.md_5.bungee.api.chat.BaseComponent previous = ( parts.isEmpty() ) ? null : parts.get( parts.size() - 1 );
        if ( previous == null )
        {
            previous = dummy;
            dummy = null;
     ...
     * @return this ComponentBuilder for chaining
     */
    public ComponentBuilder append(net.md_5.bungee.api.chat.BaseComponent[] components)
    {
     ...
     * @return this ComponentBuilder for chaining
     */
    public ComponentBuilder append(net.md_5.bungee.api.chat.BaseComponent[] components, FormatRetention retention)
    {
    ...
    {
        return append( net.md_5.bungee.api.chat.TextComponent.fromLegacyText( text ) );
    }
     ...
     * ({@code index < 0 || index >= size()})
     */
    public net.md_5.bungee.api.chat.BaseComponent getComponent(int pos) throws IndexOutOfBoundsException
    {
     ...
     */
    public net.md_5.bungee.api.chat.BaseComponent getCurrentComponent()
    {
    ...
    {
        net.md_5.bungee.api.chat.BaseComponent[] cloned = new net.md_5.bungee.api.chat.BaseComponent[ parts.size() ];
        int i = 0;
