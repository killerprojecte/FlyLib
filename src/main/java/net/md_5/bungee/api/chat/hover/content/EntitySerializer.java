...
public class EntitySerializer implements JsonSerializer<net.md_5.bungee.api.chat.hover.content.Entity>, JsonDeserializer<net.md_5.bungee.api.chat.hover.content.Entity>
{

    @Override
    public net.md_5.bungee.api.chat.hover.content.Entity deserialize(JsonElement element, Type type, JsonDeserializationContext context) throws JsonParseException
    {
